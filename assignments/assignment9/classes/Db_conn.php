...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'mshigbee';//this will be your WCC username
      $dbUsr = 'mshigbee';//this will be your WCC username
      $dbPass = 'WwuzrfsyhUfR';//this will be the password found in the video.
